...
def generate_summary(value, name):
...
def main():
    ...
    generate_summary(W_conv1, "W_conv1")
    generate_summary(b_conv1, "b_conv1")
    generate_summary(h_conv1, "h_conv1")
    generate_summary(h_pool1, "h_pool1")
    generate_summary(W_conv2, "W_conv2")
    generate_summary(b_conv2, "b_conv2")
    generate_summary(h_conv2, "h_conv2")
    generate_summary(h_pool2, "h_pool2")
    generate_summary(W_fc1, "W_fc1")
    generate_summary(b_fc1, "b_fc1")
    generate_summary(h_fc1, "activation_fc1")
    generate_summary(W_fc2, "W_fc2")
    generate_summary(b_fc2, "b_fc2")
    generate_summary(y, "activation_fc2")
    generate_summary(cross_entropy, "crossEntropy")
    generate_summary(accuracy, "accuracy")
